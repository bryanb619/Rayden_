...
public class Interactive : MonoBehaviour
{
    ...
    { PICKABLE, INTERACT_ONCE, INTERACT_MULTI, INDIRECT, TERMINAL, CYBERFRAGMENT };
    ...
    public string[] InterationTexts => _interactionTexts;
    [SerializeField] private Interactive[] _interactionChain;

    private SavePoints TerminalInteract;

    private CyberFragments CyberFragments;
    ...
    private void Start()
    {
        ...
        TerminalInteract = GetComponent<SavePoints>();
    ...
    public void Interact()
    {
        if (_isActive)
        {
            ...
            else if(_type == InteractiveType.TERMINAL)
            {
                StartTerminal();
            }

            else if (_type == InteractiveType.CYBERFRAGMENT)
            {
    ...
    {
        TerminalInteract.RunTerminalUI();
    }
